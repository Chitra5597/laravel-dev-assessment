                        ...
                        <tbody>
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row" class="px-4 py-3 font-semibold text-gray-900 whitespace-nowrap dark:text-white">{{ $job['job_title'] }}</th>
                                    <td class="px-4 py-3 whitespace-nowrap">{{ str($job['description'])->words(7) }}</td>
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ asset('logo/'.$job->logo) }}" class="h-12 w-auto block mx-auto" alt="{{ $job['company_name'] }}">
                                    </td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button
                                            ...
                                            class="text-red-500 hover:bg-slate-100 px-3 py-1.5 rounded transition">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
